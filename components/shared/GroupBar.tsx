  ...
  return (
    <div className="md:hidden sticky top-0 z-30 bg-background/95 border-b border-border/60 backdrop-blur supports-[backdrop-filter]:bg-background/80">
      ...
      <div className="flex items-center gap-1.5 px-4 pb-2">
        <svg width="13" height="14" viewBox="0 0 32 34" fill="none">
        ...
        <span style={{fontFamily: "var(--font-fraunces)"}} className="text-[11px] text-muted-foreground italic">Your private culinary space</span>
      </div>
    </div>
  );
}
